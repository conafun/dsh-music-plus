...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    // Persist the current playback position for local music (PREF_PLAYBACK).
    // This is the only source the client manages now — online QQ/酷狗 and AI 讲书
    // have been removed. (stop() clears it; a null currentId here means stopped.)
    ...
    // Restore local-music playback (PREF_PLAYBACK) — the only source the client
    // manages now (online QQ/酷狗 and AI 讲书 have been removed).
